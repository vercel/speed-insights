...
| SvelteKit 3 | `@vercel/speed-insights/sveltekit-3` |
...
3. Inject Speed Insights to your app
   ...
   - If you are using **Sveltekit**, you can use the `injectSpeedInsights()` function `@vercel/speed-insights/sveltekit-3` in your top-level `+layout.js/ts` file.
