...
| SvelteKit 3 | `@vercel/speed-insights/sveltekit`   |
| SvelteKit 2 | `@vercel/speed-insights/sveltekit-2` |
...
3. Inject Speed Insights to your app
   ...
   - If you are using **SvelteKit 3**, you can use the `injectSpeedInsights()` function from `@vercel/speed-insights/sveltekit` in your top-level `+layout.js/ts` file.
   - If you are using **SvelteKit 2**, import `injectSpeedInsights()` from `@vercel/speed-insights/sveltekit-2` instead.
